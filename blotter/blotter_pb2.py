...
_STARTREALTIMEDATAREQUEST_BARSOURCE = _descriptor.EnumDescriptor(
  name='BarSource',
  full_name='blotter.StartRealTimeDataRequest.BarSource',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_STARTREALTIMEDATAREQUEST_BARSOURCE)
...
_LOADHISTORICALDATARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='backfillJobID', full_name='blotter.LoadHistoricalDataResponse.backfillJobID', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STARTREALTIMEDATAREQUEST = _descriptor.Descriptor(
  name='StartRealTimeDataRequest',
  full_name='blotter.StartRealTimeDataRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='contractSpecifier', full_name='blotter.StartRealTimeDataRequest.contractSpecifier', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='barSource', full_name='blotter.StartRealTimeDataRequest.barSource', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='regularTradingHoursOnly', full_name='blotter.StartRealTimeDataRequest.regularTradingHoursOnly', index=2,
  ...
  nested_types=[],
  enum_types=[
    _STARTREALTIMEDATAREQUEST_BARSOURCE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_STARTREALTIMEDATARESPONSE = _descriptor.Descriptor(
  name='StartRealTimeDataResponse',
  full_name='blotter.StartRealTimeDataResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='requestID', full_name='blotter.StartRealTimeDataResponse.requestID', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CANCELREALTIMEDATAREQUEST = _descriptor.Descriptor(
  name='CancelRealTimeDataRequest',
  full_name='blotter.CancelRealTimeDataRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='requestID', full_name='blotter.CancelRealTimeDataRequest.requestID', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CANCELREALTIMEDATARESPONSE = _descriptor.Descriptor(
  name='CancelRealTimeDataResponse',
  full_name='blotter.CancelRealTimeDataResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_HEALTHCHECKREQUEST = _descriptor.Descriptor(
  ...
  full_name='blotter.HealthCheckRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_HEALTHCHECKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='blotter.HealthCheckResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_SNAPSHOTOPTIONCHAINREQUEST = _descriptor.Descriptor(
  name='SnapshotOptionChainRequest',
  full_name='blotter.SnapshotOptionChainRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='contractSpecifier', full_name='blotter.SnapshotOptionChainRequest.contractSpecifier', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SNAPSHOTOPTIONCHAINRESPONSE = _descriptor.Descriptor(
  name='SnapshotOptionChainResponse',
  full_name='blotter.SnapshotOptionChainResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='importJobID', full_name='blotter.SnapshotOptionChainResponse.importJobID', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STARTREALTIMEDATAREQUEST.fields_by_name['contractSpecifier'].message_type = _CONTRACTSPECIFIER
...
DESCRIPTOR.message_types_by_name['StartRealTimeDataRequest'] = _STARTREALTIMEDATAREQUEST
DESCRIPTOR.message_types_by_name['StartRealTimeDataResponse'] = _STARTREALTIMEDATARESPONSE
DESCRIPTOR.message_types_by_name['CancelRealTimeDataRequest'] = _CANCELREALTIMEDATAREQUEST
DESCRIPTOR.message_types_by_name['CancelRealTimeDataResponse'] = _CANCELREALTIMEDATARESPONSE
...
StartRealTimeDataRequest = _reflection.GeneratedProtocolMessageType('StartRealTimeDataRequest', (_message.Message,), {
  'DESCRIPTOR' : _STARTREALTIMEDATAREQUEST,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.StartRealTimeDataRequest)
  })
_sym_db.RegisterMessage(StartRealTimeDataRequest)

StartRealTimeDataResponse = _reflection.GeneratedProtocolMessageType('StartRealTimeDataResponse', (_message.Message,), {
  'DESCRIPTOR' : _STARTREALTIMEDATARESPONSE,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.StartRealTimeDataResponse)
  })
_sym_db.RegisterMessage(StartRealTimeDataResponse)

CancelRealTimeDataRequest = _reflection.GeneratedProtocolMessageType('CancelRealTimeDataRequest', (_message.Message,), {
  'DESCRIPTOR' : _CANCELREALTIMEDATAREQUEST,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.CancelRealTimeDataRequest)
  })
_sym_db.RegisterMessage(CancelRealTimeDataRequest)

CancelRealTimeDataResponse = _reflection.GeneratedProtocolMessageType('CancelRealTimeDataResponse', (_message.Message,), {
  'DESCRIPTOR' : _CANCELREALTIMEDATARESPONSE,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.CancelRealTimeDataResponse)
  })
_sym_db.RegisterMessage(CancelRealTimeDataResponse)

HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), {
  'DESCRIPTOR' : _HEALTHCHECKREQUEST,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.HealthCheckRequest)
  })
...
HealthCheckResponse = _reflection.GeneratedProtocolMessageType('HealthCheckResponse', (_message.Message,), {
  ...
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.HealthCheckResponse)
  })
_sym_db.RegisterMessage(HealthCheckResponse)

SnapshotOptionChainRequest = _reflection.GeneratedProtocolMessageType('SnapshotOptionChainRequest', (_message.Message,), {
  'DESCRIPTOR' : _SNAPSHOTOPTIONCHAINREQUEST,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.SnapshotOptionChainRequest)
  })
_sym_db.RegisterMessage(SnapshotOptionChainRequest)

SnapshotOptionChainResponse = _reflection.GeneratedProtocolMessageType('SnapshotOptionChainResponse', (_message.Message,), {
  'DESCRIPTOR' : _SNAPSHOTOPTIONCHAINRESPONSE,
  '__module__' : 'blotter.blotter_pb2'
  # @@protoc_insertion_point(class_scope:blotter.SnapshotOptionChainResponse)
  })
...
_BLOTTER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='HealthCheck',
    full_name='blotter.Blotter.HealthCheck',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='StartRealTimeData',
    full_name='blotter.Blotter.StartRealTimeData',
    index=2,
    containing_service=None,
    input_type=_STARTREALTIMEDATAREQUEST,
    output_type=_STARTREALTIMEDATARESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='CancelRealTimeData',
    full_name='blotter.Blotter.CancelRealTimeData',
    index=3,
    containing_service=None,
    input_type=_CANCELREALTIMEDATAREQUEST,
    output_type=_CANCELREALTIMEDATARESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='SnapshotOptionChain',
    full_name='blotter.Blotter.SnapshotOptionChain',
    index=4,
    containing_service=None,
